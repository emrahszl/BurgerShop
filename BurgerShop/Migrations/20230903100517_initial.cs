        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BurgerShopUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_BurgerShopUserId",
                        column: x => x.BurgerShopUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExtraMaterialsId = table.Column<int>(type: "int", nullable: false),
                    OrdersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraMaterialOrder", x => new { x.ExtraMaterialsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_ExtraMaterialOrder_ExtraMaterials_ExtraMaterialsId",
                        column: x => x.ExtraMaterialsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_BurgerShopUserId",
                table: "Orders",
                column: "BurgerShopUserId");
        }
